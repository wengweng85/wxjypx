...
<body class="gray-bg">
    ...
    <script src="<c:url value='/resource/hplus/js/plugins/flot/jquery.flot.symbol.js'/>"></script>
    ...
    <script src="<c:url value='/resource/hplus/js/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js'/>"></script>
    <script src="<c:url value='/resource/hplus/js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js'/>"></script>
