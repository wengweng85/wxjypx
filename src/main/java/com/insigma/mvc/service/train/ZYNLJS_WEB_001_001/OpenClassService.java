package com.insigma.mvc.service.train.ZYNLJS_WEB_001_001;
...
public interface OpenClassService {
	 ...
	 * 查询技能培训办班备案列表
	 */
	HashMap<String, Object> getInfoList(Search search) throws Exception;

	/**
	 * 根据chb100查询技能培训办班备案信息
	 */
	 ...
	 * 保存技能培训办班备案基础信息
	 */
	String saveBaseInfo(Hb68 h) throws Exception;
	...
	void submitApply(String CHB100, String AAE011) throws Exception;
	 ...
	 * 高技能人才办班提交
	 */
	void submitTopApply(String CHB100, String AAE011) throws Exception;
	/**
	 * 查询区县部门列表
	 */
